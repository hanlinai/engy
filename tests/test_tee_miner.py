...
# named apart from the dialect block's `_serve(model, override)` below: two
# helpers of the same name silently shadow, and the survivor decides which
# Serve every caller gets.
def _kv_serve():
